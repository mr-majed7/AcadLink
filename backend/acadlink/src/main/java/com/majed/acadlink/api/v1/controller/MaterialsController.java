...
@Slf4j
@Tag(name = "5. Materials Management", description = "Endpoints for managing materials")
public class MaterialsController {
     ...
     */
    @Operation(summary = "Add a new material", tags = {"5. Materials Management"})
     ...
     */
    @Operation(summary = "Get material by ID", tags = {"5. Materials Management"})
     ...
     */
    @Operation(summary = "Get materials by type and folder ID", tags = {"5. Materials Management"})
     ...
     */
    @Operation(summary = "Update material by ID", tags = {"5. Materials Management"})
     ...
     */
    @Operation(summary = "Delete material by ID", tags = {"5. Materials Management"})
