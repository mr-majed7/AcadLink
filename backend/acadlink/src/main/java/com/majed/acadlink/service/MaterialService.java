...
public class MaterialService {
    ...
    public MaterialResponseDTO saveMaterial(MaterialAddDTO materialData) {
        try {
            if (materialData.getFile() != null && !materialData.getFile().isEmpty()) {
                return saveMaterialFile(materialData);
            } else if (materialData.getLink() != null && !materialData.getLink().isEmpty()) {
                return saveMaterialLink(materialData);
            } else {
                return null;
            }
        } catch (IOException e) {
    ...
    private MaterialResponseDTO saveMaterialFile(MaterialAddDTO materialData) throws IOException {
    ...
    private MaterialResponseDTO saveMaterialLink(MaterialAddDTO materialData) {
